...
V2.11.15 20251015
1.添加sql盲注流量二分法失败和提取数据（感谢@遥记 师傅提供脚本）
2.修复多处异常功能和BUG
3.改进注册和订单找回授权机制

V2.10.8 20250626
1.支持天蝎流量解密（感谢师傅@1cePeak 提供脚本）
2.添加krb5协议解析 （感谢师傅@爻 提供脚本）
3.修复WINRM流量检测的Bug（感谢师傅@南川）
...
V2.9.3 20250428
1.增加流量包中存在多个webshell通信的情况识别，按照uri分别查找对应密钥

V2.9.2 20250425
1.修复webshell显示过滤器不生效的bug

V2.9.1 20250421
1.添加arp协议分析
2.优化主题【红粉蔚蓝】中选中文字背景色不明显的问题
3.修复http流量中登录解析的bug
4.修复webshell解密中一处bug

V2.8.3 20250418
1.当shiro流量识别到上传webshell时，计算密钥并自动添加webshell流量分析。

V2.8.2 20250324
1.开放专项功能：识别http登录成功的账号和密码

V2.8.1 20250226
1.修复若干BUG

V2.8.0 20250220
1.添加smb协议中ntlm hash识别

V2.7.3 20250122
1.优化程序启动过程

V2.7.2 20250121
1.修复matplotlib导致的启动失败

V2.7.1 20250120
1.修复更新程序的BUG

V2.7.0 20250113
1.添加专项功能：识别http登录成功的账号和密码（内测中，暂不对外）
2.优化更新检查功能
3.添加蔚蓝、红粉两种主题
...
本工具仅用于教育和辅助流量分析测试目的，使用者需遵守当地法律法规或比赛规定。  
